...
@JmixEntity
@Table(name = "CONDICAO_PAGAMENTO", indexes = {
        @Index(name = "IDX_CONDICAO_PAGAMENTO_UNQ", columnList = "CODIGO, COD_EMPRESA", unique = true)
})
@Entity
public class CondicaoPagamento {
    ...
    // sem valor padrão: o CondicaoPagamentoEventListener preenche com a empresa
