...
/**
 * Parcela/lançamento de um TituloPagar (emissão ou baixa). Mesma forma de
 * {@link ItemDiversoPagar} — ver {@link TituloPagar}.
 */
@JmixEntity
@Table(name = "ITEM_PAGAR", indexes = {
        @Index(name = "IDX_ITEM_PAGAR_TITULO_PAGAR", columnList = "TITULO_PAGAR_ID"),
        @Index(name = "IDX_ITEM_PAGAR_HISTORICO_FINANCEIRO", columnList = "HISTORICO_FINANCEIRO_ID"),
        @Index(name = "IDX_ITEM_PAGAR_BANCO", columnList = "BANCO_ID"),
        @Index(name = "IDX_ITEM_PAGAR_DATA", columnList = "DATA")
})
@Entity
public class ItemPagar {
