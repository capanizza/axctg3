...
/**
 * Parcela/lançamento de um TituloReceber (emissão ou baixa). Trazido do axctg-flow, só
 * entidade + changelog por ora — ver TituloReceber.
 */
@JmixEntity
@Table(name = "ITEM_RECEBER", indexes = {
        @Index(name = "IDX_ITEM_RECEBER_TITULO_RECEBER", columnList = "TITULO_RECEBER_ID"),
        @Index(name = "IDX_ITEM_RECEBER_HISTORICO_FINANCEIRO", columnList = "HISTORICO_FINANCEIRO_ID"),
        @Index(name = "IDX_ITEM_RECEBER_DATA", columnList = "DATA")
})
@Entity
public class ItemReceber {
