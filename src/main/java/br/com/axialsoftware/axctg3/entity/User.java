...
public class User implements JmixUserDetails, HasTimeZone {
    ...
    @Column(name = "ANO_CONTABIL")
    private Integer anoContabil;

    @Min(1)
    @Max(12)
    @Column(name = "MES_CONTABIL")
    private Integer mesContabil;
    ...
    public void setCodEmpresa(final Integer codEmpresa) {
    ...
    public void setAnoContabil(final Integer anoContabil) {
        this.anoContabil = anoContabil;
    }
    ...
    public void setMesContabil(final Integer mesContabil) {
        this.mesContabil = mesContabil;
    }
    ...
    public void setAnoFiscal(final Integer anoFiscal) {
    ...
    public void setMesFiscal(final Integer mesFiscal) {
