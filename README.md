...
The newly created project requires Java 21 and uses the Postgres database.
...
To start the application, use the **Axctg3 Jmix Application** run configuration in your IDE, or run the following command in the project root directory:

```bash
./gradlew bootRun
```

The application will be available at <http://localhost:8085/axctg3>.
